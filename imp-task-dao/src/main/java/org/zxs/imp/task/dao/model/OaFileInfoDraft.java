...
@Entity
@Table(name="oa_file_info_draft")
public class OaFileInfoDraft {
	@Id
	...
	@JSONField(ordinal=3)
	@Column(name="file_guid", nullable = false, unique = true, length = 100, columnDefinition = "OA文件编号")
    ...
    public boolean equals(Object that) {
        ...
        OaFileInfoDraft other = (OaFileInfoDraft) that;
