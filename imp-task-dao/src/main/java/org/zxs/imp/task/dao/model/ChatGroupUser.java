...
public class ChatGroupUser {
	...
	@JSONField(ordinal=2)
	@Column(name="chat_group_id", nullable = false, unique = false, length = 10, columnDefinition = "群组编号")
    private Integer chatGroupId;

	@JSONField(ordinal=3)
	@Column(name="user_id", nullable = false, unique = false, length = 10, columnDefinition = "群组用户编号")
    private Integer userId;

	@JSONField(ordinal=4)
	@Column(name="nickname", nullable = true, unique = false, length = 30, columnDefinition = "群内名称")
    private String nickname;

	@JSONField(ordinal=5)
	@Column(name="role", nullable = false, unique = false, length = 3, columnDefinition = "用户角色，0为群主，1为管理员，2为群成员")
    private Byte role;

	@JSONField(ordinal=6)
	@Column(name="removeable", nullable = false, unique = false, length = 3, columnDefinition = "是否能删除，0为否，1为是")
    private Byte removeable = REMOVE_ALLOW;

	@JSONField(ordinal=7)
	@Column(name="create_at", updatable = false, nullable = false, unique = false, length = 3, columnDefinition = "创建时间")
